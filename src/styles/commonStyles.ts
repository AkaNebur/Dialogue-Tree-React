...
export const colors = {
  ...
  export const panelStyles = {
    ...
    variants: {
      sidebar: 'w-64',
      modal: 'w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col', // Default styles if needed elsewhere
  ...
  export const modalStyles = {
    ...
    // *** MODIFIED: Removed w-full and max-w-lg ***
    content: `${colors.bg.surface} rounded-lg shadow-xl max-h-[90vh] overflow-hidden flex flex-col ${effects.transition.normal}`,
