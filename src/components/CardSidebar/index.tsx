 ...
 * Updated with consistent dark mode styling matching the NodePositioner component
 */
      ...
      <div className="card-sidebar rounded-xl shadow-lg bg-blue-50 dark:bg-dark-surface p-3 border border-blue-100 dark:border-dark-border w-64 transition-colors duration-300">
        ...
        <div className="flex justify-between items-center mb-2 px-1">
          ...
          <button 
            ...
            className="bg-blue-100 hover:bg-blue-200 dark:bg-dark-bg dark:hover:bg-gray-800 text-blue-600 dark:text-gray-300 rounded-full p-1.5 transition-colors shadow-md"
          >
            <Plus size={16} />
          </button>
        </div>
        ...
        {isAddingNpc ? (
          <form onSubmit={handleAddNpc} className="mb-3">
            <input
              ...
              className="w-full p-2 mb-2 border border-blue-200 dark:border-dark-border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-dark-accent shadow-inner bg-white dark:bg-dark-bg dark:text-dark-text"
              autoFocus
            />
            <div className="flex gap-2">
              <button 
                ...
                className="flex-1 px-2 py-1.5 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-md text-xs font-medium transition-colors shadow-md"
              >
                Cancel
              </button>
              <button
                type="submit"
                className="flex-1 px-2 py-1.5 bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white rounded-md text-xs font-medium transition-colors shadow-md"
              >
                Add
              </button>
            </div>
          ...
          {npcs.map((npc) => (
            ...
            >
              <button
                ...
                className="w-full text-left p-2 pr-8 rounded-lg text-sm font-medium dark:text-dark-text"
              >
                {npc.name}
              </button>
              <button className="card-icon absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-dark-accent p-1 rounded-full">
                <Settings size={18} />
              </button>
            </div>
          ))}
        ...
        <div className="flex justify-between items-center mb-2 px-1">
          ...
          {selectedNpc && (
            <button 
              ...
              } rounded-full p-1.5 transition-colors shadow-md`}
            >
              <Plus size={16} />
            </button>
          )}
